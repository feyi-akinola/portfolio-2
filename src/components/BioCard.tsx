...
export default function BioCard({ onMouseEnter, cardRef, style }: BioCardProps) {
  return (
    <div
      ref={cardRef}
      ...
      style={style}
    >
      <p className="text-sm leading-relaxed text-neutral-500 whitespace-normal">{BIO_TEXT}</p>
    </div>
  );
}
